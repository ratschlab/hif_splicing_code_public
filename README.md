...
- `indir`: The directory containing all spladder result files 
- `RESULTS_FOLDER`: The directory where you would like all differential test result files to be output.
